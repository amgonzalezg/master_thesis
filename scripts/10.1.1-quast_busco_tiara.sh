...
mkdir -p data/clean/qbt_subset
mkdir -p data/clean/qbt_subset/quast/quast_output
mkdir -p data/clean/qbt_subset/busco/
mkdir -p data/clean/qbt_subset/tiara/tiara_out
...
quast.py \
 ...
 -o data/clean/qbt_subset/quast/quast_output \
 -t ${NUM_THREADS} \
...
cd data/clean/qbt_subset/busco
...
tiara \
 ...
 -o data/clean/qbt_subset/tiara/tiara_out/tiara_output
